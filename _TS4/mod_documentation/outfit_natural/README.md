...
- Sims may revert to their previous outfits very shortly after switching into their bathing outfit. 
  This behavior is part of how The Sims 4 handles outfit changes and is not controlled by this mod.
- Sims may get an embarrassed moodlet.
- Many gamers get embarrassed when they see the censor mosaic.
